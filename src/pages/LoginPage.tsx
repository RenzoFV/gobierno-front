...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-background px-4 py-8">
      <div className="animate-panel mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-6xl overflow-hidden rounded-lg border bg-card text-card-foreground shadow-xl lg:grid-cols-[1.05fr_0.95fr]">
        <section className="relative hidden bg-sidebar p-10 text-sidebar-foreground lg:flex lg:flex-col lg:justify-between">
          <div className="absolute inset-x-0 top-0 h-1 bg-primary" />
          <div>
            <div className="mb-10 flex h-12 w-12 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground">
              <ShieldCheck className="h-6 w-6" />
            </div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-wide text-sidebar-foreground/60">Gobierno TI</p>
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              ...
              <div key={title} className="animate-pop rounded-lg border border-white/10 bg-white/5 p-4">
                ...
                <p className="text-xs text-sidebar-foreground/50">{subtitle}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <main className="flex animate-page items-center justify-center p-6 sm:p-10">
          <Card className="w-full max-w-md border-0 shadow-none">
            <div className="mb-8">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-accent text-accent-foreground lg:hidden">
                <ShieldCheck className="h-6 w-6" />
              </div>
              ...
              <h2 className="text-2xl font-bold text-foreground">Inicia sesion</h2>
              <p className="mt-1 text-sm text-muted-foreground">Continua con tu cuenta para revisar cambios y riesgos.</p>
            </div>
            ...
            <div className="mt-6 rounded-lg border bg-muted/60 p-3">
              <p className="mb-2 text-xs font-semibold uppercase text-muted-foreground">Acceso demo</p>
